...
interface GeneralCustomizer {
     ...
     * @param lifecycleOwner: The lifecycle of the view of the Fragment that is getting customized.
     * Can be used to observe the lifecycle and for example clear any potential references when
     * onDestroyView is called.
     */
    fun customize(className: String, view: View, lifecycleOwner: LifecycleOwner)
}