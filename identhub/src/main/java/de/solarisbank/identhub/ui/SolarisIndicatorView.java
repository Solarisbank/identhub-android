...
public class SolarisIndicatorView extends StepIndicator {
    ...
    public SolarisIndicatorView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public SolarisIndicatorView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        step1 = inflatedView.findViewById(R.id.step1Line);
        step2 = inflatedView.findViewById(R.id.step2Line);
        step3 = inflatedView.findViewById(R.id.step3Line);
