...
class JointAccountBankIdPostUseCaseFactory private constructor(
    ...
    companion object {
        fun create(verificationBankRepositoryProvider: Provider<VerificationBankRepository>): JointAccountBankIdPostUseCaseFactory {
            return JointAccountBankIdPostUseCaseFactory(verificationBankRepositoryProvider)
        }
    }
}