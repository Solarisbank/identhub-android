...
public class VerificationPhoneFragment extends BaseFragment {
    ...
    private VerificationPhoneViewModel viewModel;
    ...
    private void initViewModel() {
        viewModel = new ViewModelProvider(this, viewModelFactory)
                .get(VerificationPhoneViewModel.class);
    ...
    private void onStateOfDigitInputChanged(int state) {
        ...
        binding.submitButton.setText(state == DISABLED_STATE ? R.string.verification_phone_status_verifying : R.string.verification_phone_action_submit);
        ...
        if (state == SUCCESS_STATE) {
            sharedViewModel.navigateTo(R.id.action_verificationPhoneFragment2_to_verificationPhoneSuccessMessageFragment);
        }
    }
