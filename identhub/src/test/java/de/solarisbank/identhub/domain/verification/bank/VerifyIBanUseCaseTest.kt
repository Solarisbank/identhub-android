...
class VerifyIBanUseCaseTest : StringSpec({
    ...
    val IbanJointAccount200Response =
        "{" +
            ...
            "\"reference\":null," +
            "\"url\":\"https://solarisbank-payment-wizard-sandbox.s3.eu-central-1.amazonaws.com" +
    ...
    "IbanJointAccount200" {
        ...
        ibanVerificationSuccessful.bankIdentificationUrl should
                startWith(
                    "https://solarisbank-payment-wizard-sandbox.s3.eu-central-1.amazonaws.com/index.html?wizard_session_key=a4cEiyJ0Z4ni"
                )
