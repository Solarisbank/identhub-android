...
import de.solarisbank.sdk.fourthline.FourthlineViewModelFactory
...
internal class FourthlineSaveStateViewModelMapProvider(private val fourthlineModule: FourthlineModule) : Provider<Map<Class<out ViewModel>, Factory2<ViewModel, SavedStateHandle>>> {
    ...
    companion object {
        fun create(fourthlineModule: FourthlineModule): FourthlineSaveStateViewModelMapProvider {
            return FourthlineSaveStateViewModelMapProvider(fourthlineModule)
        }
    }
}