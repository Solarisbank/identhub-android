...
import de.solarisbank.sdk.fourthline.data.ip.*
...
import de.solarisbank.sdk.fourthline.data.person.PersonDataApiFactory
import de.solarisbank.sdk.fourthline.data.person.PersonDataDataSource
import de.solarisbank.sdk.fourthline.data.person.PersonDataDataSourceFactory
...
import de.solarisbank.sdk.fourthline.domain.ip.IpObtainingUseCaseFactory
...
class FourthlineTestComponent private constructor(
    ...
    private fun initialize() {
        ...
        identityInitializationDataSourceProvider = DoubleCheck.provider(object : Factory<IdentityInitializationDataSource> {
            override fun get(): IdentityInitializationDataSource {
                return IdentityInitializationInMemoryDataSource()
            }
        })
        identityInitializationRepositoryProvider = DoubleCheck.provider(
            IdentityInitializationRepositoryFactory.create(identityInitializationDataSourceProvider))
